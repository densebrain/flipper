...
public class LithoRecyclerViewDescriptor extends NodeDescriptor<LithoRecylerView> {
  ...
  public void invalidate(final LithoRecylerView node) {
    ...
    new com.facebook.states.core.ErrorReportingRunnable(mConnection) {
      @Override
  ...
  @Override
  public List<Named<StatesObject>> getData(LithoRecylerView node) throws Exception {
  ...
  @Override
  public void setValue(LithoRecylerView node, String[] path, StatesDynamic value)
      throws Exception {
    final NodeDescriptor descriptor = descriptorForClass(ViewGroup.class);
  ...
  @Override
  public StatesObject getExtraInfo(LithoRecylerView node) {
    final NodeDescriptor descriptor = descriptorForClass(ViewGroup.class);
