 ...
 */
package com.facebook.states.plugins.inspector.descriptors.utils;
...
public final class AccessibilityUtil {
  ...
  /**
   * Creates a {@link StatesObject} of useful properties of AccessibilityNodeInfo, to be shown in
   * the States Layout Inspector accessibility extension. All properties are immutable since they
   ...
   * @return {@link StatesObject} containing the properties.
   */
  @Nullable
  public static StatesObject getAccessibilityNodeInfoData(View view) {
    ...
    final StatesObject.Builder nodeInfoProps = new StatesObject.Builder();
    final Rect bounds = new Rect();

    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
      final StatesArray.Builder actionsArrayBuilder = new StatesArray.Builder();
  ...
  /**
   * Modifies a {@link StatesObject.Builder} to add Talkback-specific Accessibiltiy properties to
   * be shown in the States Layout Inspector.
   *
   * @param props The {@link StatesObject.Builder} to add the properties to.
   * @param view The {@link View} to derive the properties from.
   */
  public static void addTalkbackProperties(StatesObject.Builder props, View view) {
  ...
  public static StatesObject getViewData(View view) {
  ...
  public static StatesObject getTalkbackData(View view) {
    if (!AccessibilityEvaluationUtil.isTalkbackFocusable(view)) {
