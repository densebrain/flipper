...
public class StatesDynamic {
  private final Object mObject;

  public StatesDynamic(Object object) {
    mObject = object;
  }
  ...
  public StatesObject asObject() {
    if (mObject instanceof JSONObject) {
      return new StatesObject((JSONObject) mObject);
    }
    return (StatesObject) mObject;
  }

  public StatesArray asArray() {
    if (mObject instanceof JSONArray) {
      return new StatesArray((JSONArray) mObject);
    }
    return (StatesArray) mObject;
  }
}
