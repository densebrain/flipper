...
public class SupportDialogFragmentDescriptor extends NodeDescriptor<DialogFragment> {
  ...
  @Override
  public List<Named<StatesObject>> getData(DialogFragment node) throws Exception {
    final NodeDescriptor descriptor = descriptorForClass(Fragment.class);
    return descriptor.getData(node);
  }

  @Override
  public void setValue(DialogFragment node, String[] path, StatesDynamic value) throws Exception {
    final NodeDescriptor descriptor = descriptorForClass(Fragment.class);
  ...
  @Override
  public StatesObject getExtraInfo(DialogFragment node) {
    final NodeDescriptor descriptor = descriptorForClass(Fragment.class);
