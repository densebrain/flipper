...
public class StatesArray {
  ...
  public StatesArray(JSONArray json) {
    mJson = (json != null ? json : new JSONArray());
  }

  public StatesArray(String json) {
    try {
  ...
  public StatesDynamic getDynamic(int index) {
    return new StatesDynamic(mJson.opt(index));
  }
  ...
  public StatesObject getObject(int index) {
    final Object o = mJson.opt(index);
    return new StatesObject((JSONObject) o);
  }

  public StatesArray getArray(int index) {
    final Object o = mJson.opt(index);
  ...
  public static class Builder {
    ...
    public Builder put(StatesValue v) {
      return put(v.toStatesObject());
    }

    public Builder put(StatesArray a) {
      mJson.put(a == null ? null : a.mJson);
      return this;
    }

    public Builder put(StatesArray.Builder b) {
      return put(b.build());
    }

    public Builder put(StatesObject o) {
      mJson.put(o == null ? null : o.mJson);
      return this;
    }

    public Builder put(StatesObject.Builder b) {
      return put(b.build());
    }

    public StatesArray build() {
      return new StatesArray(mJson);
    }
  }
}
