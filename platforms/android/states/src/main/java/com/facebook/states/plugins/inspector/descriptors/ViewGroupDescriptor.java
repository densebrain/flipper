...
import static com.facebook.states.plugins.inspector.InspectorValue.Type.Boolean;
import static com.facebook.states.plugins.inspector.InspectorValue.Type.Enum;

import android.os.Build;
import android.view.View;
import android.view.ViewGroup;
import com.facebook.states.R;
...
import com.facebook.states.plugins.inspector.HiddenNode;
...
public class ViewGroupDescriptor extends NodeDescriptor<ViewGroup> {
  ...
  @Override
  public List<Named<StatesObject>> getData(ViewGroup node) throws Exception {
    final List<Named<StatesObject>> props = new ArrayList<>();
    final NodeDescriptor descriptor = descriptorForClass(View.class);

    final StatesObject.Builder vgProps = new StatesObject.Builder();
  ...
  @Override
  public List<Named<StatesObject>> getAXData(ViewGroup node) throws Exception {
    final List<Named<StatesObject>> props = new ArrayList<>();
    final NodeDescriptor descriptor = descriptorForClass(View.class);
  ...
  @Override
  public void setValue(ViewGroup node, String[] path, StatesDynamic value) throws Exception {
    switch (path[0]) {
      case "ViewGroup":
        switch (path[1]) {
          case "layoutMode":
  ...
  @Override
  public StatesObject getExtraInfo(ViewGroup node) {
    final NodeDescriptor descriptor = descriptorForClass(View.class);
  ...
  private static boolean shouldSkip(View view) {
    Object tag = view.getTag(R.id.states_skip_view_traversal);
