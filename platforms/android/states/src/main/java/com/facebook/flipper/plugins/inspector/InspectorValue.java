...
import com.facebook.states.core.StatesValue;

public class InspectorValue<T> implements StatesValue {

  /**
   * Descrive the type of data this value contains. This will influence how values are parsed and
   * displayed by the States desktop app. For example colors will be parse as integers and
  ...
  @Override
  public StatesObject toStatesObject() {
