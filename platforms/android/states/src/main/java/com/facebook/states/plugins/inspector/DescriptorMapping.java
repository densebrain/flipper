...
import com.facebook.states.plugins.inspector.descriptors.ActivityDescriptor;
import com.facebook.states.plugins.inspector.descriptors.ApplicationDescriptor;
import com.facebook.states.plugins.inspector.descriptors.DialogDescriptor;
import com.facebook.states.plugins.inspector.descriptors.DialogFragmentDescriptor;
import com.facebook.states.plugins.inspector.descriptors.DrawableDescriptor;
import com.facebook.states.plugins.inspector.descriptors.FragmentDescriptor;
import com.facebook.states.plugins.inspector.descriptors.ObjectDescriptor;
import com.facebook.states.plugins.inspector.descriptors.SupportDialogFragmentDescriptor;
import com.facebook.states.plugins.inspector.descriptors.SupportFragmentDescriptor;
import com.facebook.states.plugins.inspector.descriptors.TextViewDescriptor;
import com.facebook.states.plugins.inspector.descriptors.ViewDescriptor;
import com.facebook.states.plugins.inspector.descriptors.ViewGroupDescriptor;
import com.facebook.states.plugins.inspector.descriptors.WindowDescriptor;
...
public class DescriptorMapping {
  ...
  void onConnect(StatesConnection connection) {
