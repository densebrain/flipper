...
import static com.facebook.states.plugins.inspector.InspectorValue.Type.Text;
...
public class TextViewDescriptor extends NodeDescriptor<TextView> {
  ...
  @Override
  public List<Named<StatesObject>> getData(TextView node) throws Exception {
  ...
  @Override
  public List<Named<StatesObject>> getAXData(TextView node) throws Exception {
    final List<Named<StatesObject>> props = new ArrayList<>();
    final NodeDescriptor descriptor = descriptorForClass(View.class);
  ...
  @Override
  public void setValue(TextView node, String[] path, StatesDynamic value) throws Exception {
    switch (path[0]) {
      case "TextView":
        switch (path[1]) {
          case "text":
  ...
  @Override
  public StatesObject getExtraInfo(TextView node) {
    final NodeDescriptor descriptor = descriptorForClass(View.class);
