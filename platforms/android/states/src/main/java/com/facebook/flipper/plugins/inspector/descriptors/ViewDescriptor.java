 ...
 */
package com.facebook.states.plugins.inspector.descriptors;
...
import com.facebook.states.plugins.inspector.descriptors.utils.AccessibilityEvaluationUtil;
import com.facebook.states.plugins.inspector.descriptors.utils.AccessibilityRoleUtil;
import com.facebook.states.plugins.inspector.descriptors.utils.AccessibilityUtil;
import com.facebook.states.plugins.inspector.descriptors.utils.EnumMapping;
import com.facebook.states.plugins.inspector.descriptors.utils.ViewAccessibilityHelper;
...
public class ViewDescriptor extends NodeDescriptor<View> {
  ...
  @Override
  public List<Named<StatesObject>> getData(View node) {
    final StatesObject.Builder viewProps =
    ...
    StatesObject.Builder translation =
        new StatesObject.Builder()
  ...
  @Override
  public List<Named<StatesObject>> getAXData(View node) {
  ...
  @Override
  public void setValue(View node, String[] path, StatesDynamic value) {
  ...
  private void setAccessibilityValue(View node, String[] path, StatesDynamic value) {
    switch (path[1]) {
      case "focusable":
  ...
  @Override
  public StatesObject getExtraInfo(View node) {
  ...
  private StatesObject getTags(final View node) {
    final StatesObject.Builder tags = new StatesObject.Builder();
  ...
  private static StatesObject getLayoutParams(View node) {
    final LayoutParams layoutParams = node.getLayoutParams();
    final StatesObject.Builder params = new StatesObject.Builder();
  ...
  private void setLayoutParams(View node, String[] path, StatesDynamic value) {
