...
package com.facebook.states.plugins.network;
...
public class NetworkStatesPlugin extends BufferingStatesPlugin implements NetworkReporter {
  public static final String ID = "@states/plugin-network";

  private final List<NetworkResponseFormatter> mFormatters;

  public NetworkStatesPlugin() {
    this(null);
  }

  public NetworkStatesPlugin(List<NetworkResponseFormatter> formatters) {
  ...
  public void reportRequest(RequestInfo requestInfo) {
    final StatesObject request =
        new StatesObject.Builder()
            ...
            .put("headers", toStatesObject(requestInfo.headers))
          ...
          protected void runOrThrow() throws Exception {
            ...
            final StatesObject response =
                new StatesObject.Builder()
                    ...
                    .put("headers", toStatesObject(responseInfo.headers))
  ...
  private StatesArray toStatesObject(List<Header> headers) {
    final StatesArray.Builder list = new StatesArray.Builder();

    for (Header header : headers) {
      list.put(new StatesObject.Builder().put("key", header.name).put("value", header.value));
    }
