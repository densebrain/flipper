...
public class LithoViewDescriptor extends NodeDescriptor<LithoView> {
  ...
  @Override
  public List<Named<StatesObject>> getData(LithoView node) throws Exception {
  ...
  @Override
  public List<Named<StatesObject>> getAXData(LithoView node) throws Exception {
    final List<Named<StatesObject>> props = new ArrayList<>();
    final NodeDescriptor descriptor = descriptorForClass(ViewGroup.class);
  ...
  @Override
  public void setValue(LithoView node, String[] path, StatesDynamic value) throws Exception {
    final NodeDescriptor descriptor = descriptorForClass(ViewGroup.class);
  ...
  @Override
  public StatesObject getExtraInfo(LithoView node) {
    final NodeDescriptor descriptor = descriptorForClass(ViewGroup.class);
