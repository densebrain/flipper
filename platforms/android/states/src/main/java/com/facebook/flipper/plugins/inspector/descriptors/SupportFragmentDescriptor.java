...
public class SupportFragmentDescriptor extends NodeDescriptor<Fragment> {
  ...
  @Override
  public List<Named<StatesObject>> getData(Fragment node) {
    final Bundle args = node.getArguments();
    if (args == null || args.isEmpty()) {
      return Collections.EMPTY_LIST;
    }

    final StatesObject.Builder bundle = new StatesObject.Builder();
  ...
  @Override
  public void setValue(Fragment node, String[] path, StatesDynamic value) {}
  ...
  @Override
  public StatesObject getExtraInfo(Fragment node) {
    return new StatesObject.Builder().put("nonAXWithAXChild", true).build();
  }
