...
import static com.facebook.stato.plugins.inspector.ThrowableMessageMatcher.hasThrowableWithMessage;
...
import com.facebook.stato.plugins.inspector.InspectorStatoPlugin.TouchOverlayView;
...
public class InspectorStatoPluginTest {
  ...
  public void setup() {
    ...
    Mockito.when(app.getPackageName()).thenReturn("com.facebook.stato");
  ...
  public void testOnConnect() throws Exception {
    ...
    final StatoConnection connection = new StatoConnectionMock();
    ...
    assertThat(
        ...
        hasItem(
            new StatoObject.Builder()
                .put("id", "com.facebook.stato")
                .put("name", "com.facebook.stato")
  ...
  public void testSetHighlighted() throws Exception {
    ...
    plugin.mSetHighlighted.onReceive(
        new StatoObject.Builder().put("id", "com.facebook.stato").build(), responder);
    ...
    assertThat(
        ...
        hasItem(
            new StatoObject.Builder()
                .put(
                    "path",
                    new StatoArray.Builder().put("com.facebook.stato").put("test").put("3"))
                .build()));
  }
