...
public class LithoViewDescriptor extends NodeDescriptor<LithoView> {
  ...
  @Override
  public List<Named<StatoObject>> getData(LithoView node) throws Exception {
  ...
  @Override
  public List<Named<StatoObject>> getAXData(LithoView node) throws Exception {
    final List<Named<StatoObject>> props = new ArrayList<>();
    final NodeDescriptor descriptor = descriptorForClass(ViewGroup.class);
  ...
  @Override
  public void setValue(LithoView node, String[] path, StatoDynamic value) throws Exception {
    final NodeDescriptor descriptor = descriptorForClass(ViewGroup.class);
  ...
  @Override
  public StatoObject getExtraInfo(LithoView node) {
    final NodeDescriptor descriptor = descriptorForClass(ViewGroup.class);
