...
import com.facebook.stato.plugins.inspector.descriptors.ActivityDescriptor;
import com.facebook.stato.plugins.inspector.descriptors.ApplicationDescriptor;
import com.facebook.stato.plugins.inspector.descriptors.DialogDescriptor;
import com.facebook.stato.plugins.inspector.descriptors.DialogFragmentDescriptor;
import com.facebook.stato.plugins.inspector.descriptors.DrawableDescriptor;
import com.facebook.stato.plugins.inspector.descriptors.FragmentDescriptor;
import com.facebook.stato.plugins.inspector.descriptors.ObjectDescriptor;
import com.facebook.stato.plugins.inspector.descriptors.SupportDialogFragmentDescriptor;
import com.facebook.stato.plugins.inspector.descriptors.SupportFragmentDescriptor;
import com.facebook.stato.plugins.inspector.descriptors.TextViewDescriptor;
import com.facebook.stato.plugins.inspector.descriptors.ViewDescriptor;
import com.facebook.stato.plugins.inspector.descriptors.ViewGroupDescriptor;
import com.facebook.stato.plugins.inspector.descriptors.WindowDescriptor;
...
public class DescriptorMapping {
  ...
  void onConnect(StatoConnection connection) {
