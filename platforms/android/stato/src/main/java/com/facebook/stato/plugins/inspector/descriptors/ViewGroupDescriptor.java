...
import static com.facebook.stato.plugins.inspector.InspectorValue.Type.Boolean;
import static com.facebook.stato.plugins.inspector.InspectorValue.Type.Enum;

import android.os.Build;
import android.view.View;
import android.view.ViewGroup;
import com.facebook.stato.R;
...
import com.facebook.stato.plugins.inspector.HiddenNode;
...
public class ViewGroupDescriptor extends NodeDescriptor<ViewGroup> {
  ...
  @Override
  public List<Named<StatoObject>> getData(ViewGroup node) throws Exception {
    final List<Named<StatoObject>> props = new ArrayList<>();
    final NodeDescriptor descriptor = descriptorForClass(View.class);

    final StatoObject.Builder vgProps = new StatoObject.Builder();
  ...
  @Override
  public List<Named<StatoObject>> getAXData(ViewGroup node) throws Exception {
    final List<Named<StatoObject>> props = new ArrayList<>();
    final NodeDescriptor descriptor = descriptorForClass(View.class);
  ...
  @Override
  public void setValue(ViewGroup node, String[] path, StatoDynamic value) throws Exception {
    switch (path[0]) {
      case "ViewGroup":
        switch (path[1]) {
          case "layoutMode":
  ...
  @Override
  public StatoObject getExtraInfo(ViewGroup node) {
    final NodeDescriptor descriptor = descriptorForClass(View.class);
  ...
  private static boolean shouldSkip(View view) {
    Object tag = view.getTag(R.id.stato_skip_view_traversal);
