...
public abstract class NodeDescriptor<T> {
  @Nullable protected StatoConnection mConnection;
  private DescriptorMapping mDescriptorMapping;

  void setConnection(StatoConnection connection) {
        ...
        protected void runOrThrow() throws Exception {
          StatoArray array =
              new StatoArray.Builder()
                  .put(new StatoObject.Builder().put("id", getId(node)).build())
                  .build();
          StatoObject params = new StatoObject.Builder().put("nodes", array).build();
   ...
   */
  public abstract List<Named<StatoObject>> getData(T node) throws Exception;

  /** Gets data for AX tree */
  public List<Named<StatoObject>> getAXData(T node) throws Exception {
   ...
   */
  public abstract void setValue(T node, String[] path, StatoDynamic value) throws Exception;
   ...
   *     up, etc.
   */
  public StatoObject getExtraInfo(T node) {
    return new StatoObject.Builder().build();
  }
