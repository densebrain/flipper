...
public class DialogFragmentDescriptor extends NodeDescriptor<DialogFragment> {
  ...
  @Override
  public List<Named<StatoObject>> getData(DialogFragment node) throws Exception {
    final NodeDescriptor descriptor = descriptorForClass(Fragment.class);
    return descriptor.getData(node);
  }

  @Override
  public void setValue(DialogFragment node, String[] path, StatoDynamic value) throws Exception {
    final NodeDescriptor descriptor = descriptorForClass(Fragment.class);
  ...
  @Override
  public StatoObject getExtraInfo(DialogFragment node) {
    final NodeDescriptor descriptor = descriptorForClass(Fragment.class);
