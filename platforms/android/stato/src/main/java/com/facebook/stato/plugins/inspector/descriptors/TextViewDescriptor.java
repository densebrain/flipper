...
import static com.facebook.stato.plugins.inspector.InspectorValue.Type.Text;
...
public class TextViewDescriptor extends NodeDescriptor<TextView> {
  ...
  @Override
  public List<Named<StatoObject>> getData(TextView node) throws Exception {
  ...
  @Override
  public List<Named<StatoObject>> getAXData(TextView node) throws Exception {
    final List<Named<StatoObject>> props = new ArrayList<>();
    final NodeDescriptor descriptor = descriptorForClass(View.class);
  ...
  @Override
  public void setValue(TextView node, String[] path, StatoDynamic value) throws Exception {
    switch (path[0]) {
      case "TextView":
        switch (path[1]) {
          case "text":
  ...
  @Override
  public StatoObject getExtraInfo(TextView node) {
    final NodeDescriptor descriptor = descriptorForClass(View.class);
