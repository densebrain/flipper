 ...
 */
package com.facebook.stato.plugins.inspector.descriptors.utils;
...
public final class AccessibilityUtil {
  ...
  /**
   * Creates a {@link StatoObject} of useful properties of AccessibilityNodeInfo, to be shown in
   ...
   * @return {@link StatoObject} containing the properties.
   */
  @Nullable
  public static StatoObject getAccessibilityNodeInfoData(View view) {
    ...
    final StatoObject.Builder nodeInfoProps = new StatoObject.Builder();
    final Rect bounds = new Rect();

    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
      final StatoArray.Builder actionsArrayBuilder = new StatoArray.Builder();
  ...
  /**
   * Modifies a {@link StatoObject.Builder} to add Talkback-specific Accessibiltiy properties to
   * be shown in the Stato Layout Inspector.
   *
   * @param props The {@link StatoObject.Builder} to add the properties to.
   * @param view The {@link View} to derive the properties from.
   */
  public static void addTalkbackProperties(StatoObject.Builder props, View view) {
  ...
  public static StatoObject getViewData(View view) {
  ...
  public static StatoObject getTalkbackData(View view) {
    if (!AccessibilityEvaluationUtil.isTalkbackFocusable(view)) {
