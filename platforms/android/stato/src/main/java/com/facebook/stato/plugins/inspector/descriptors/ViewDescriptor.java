 ...
 */
package com.facebook.stato.plugins.inspector.descriptors;
...
import com.facebook.stato.plugins.inspector.descriptors.utils.AccessibilityEvaluationUtil;
import com.facebook.stato.plugins.inspector.descriptors.utils.AccessibilityRoleUtil;
import com.facebook.stato.plugins.inspector.descriptors.utils.AccessibilityUtil;
import com.facebook.stato.plugins.inspector.descriptors.utils.EnumMapping;
import com.facebook.stato.plugins.inspector.descriptors.utils.ViewAccessibilityHelper;
...
public class ViewDescriptor extends NodeDescriptor<View> {
  ...
  @Override
  public List<Named<StatoObject>> getData(View node) {
    final StatoObject.Builder viewProps =
    ...
    StatoObject.Builder translation =
        new StatoObject.Builder()
  ...
  @Override
  public List<Named<StatoObject>> getAXData(View node) {
  ...
  @Override
  public void setValue(View node, String[] path, StatoDynamic value) {
  ...
  private void setAccessibilityValue(View node, String[] path, StatoDynamic value) {
    switch (path[1]) {
      case "focusable":
  ...
  @Override
  public StatoObject getExtraInfo(View node) {
  ...
  private StatoObject getTags(final View node) {
    final StatoObject.Builder tags = new StatoObject.Builder();
  ...
  private static StatoObject getLayoutParams(View node) {
    final LayoutParams layoutParams = node.getLayoutParams();
    final StatoObject.Builder params = new StatoObject.Builder();
  ...
  private void setLayoutParams(View node, String[] path, StatoDynamic value) {
