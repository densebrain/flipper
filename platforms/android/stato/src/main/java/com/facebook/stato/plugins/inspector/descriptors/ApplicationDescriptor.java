...
public class ApplicationDescriptor extends NodeDescriptor<ApplicationWrapper> {
              ...
              public boolean onRequestSendAccessibilityEvent(
                ...
                if (mConnection != null) {
                  ...
                  if (eventType == AccessibilityEvent.TYPE_VIEW_ACCESSIBILITY_FOCUSED) {
                    mConnection.send(
                        "axFocusEvent", new StatoObject.Builder().put("isFocus", true).build());
                  } else if (eventType
                      == AccessibilityEvent.TYPE_VIEW_ACCESSIBILITY_FOCUS_CLEARED) {
                    mConnection.send(
                        "axFocusEvent", new StatoObject.Builder().put("isFocus", false).build());
  ...
  @Override
  public List<Named<StatoObject>> getData(ApplicationWrapper node) {
    return Collections.EMPTY_LIST;
  }

  @Override
  public void setValue(ApplicationWrapper node, String[] path, StatoDynamic value) {}
  ...
  @Override
  public StatoObject getExtraInfo(ApplicationWrapper node) {
    return new StatoObject.Builder().put("hasAXNode", true).build();
  }
