...
public class SupportFragmentDescriptor extends NodeDescriptor<Fragment> {
  ...
  @Override
  public List<Named<StatoObject>> getData(Fragment node) {
    final Bundle args = node.getArguments();
    if (args == null || args.isEmpty()) {
      return Collections.EMPTY_LIST;
    }

    final StatoObject.Builder bundle = new StatoObject.Builder();
  ...
  @Override
  public void setValue(Fragment node, String[] path, StatoDynamic value) {}
  ...
  @Override
  public StatoObject getExtraInfo(Fragment node) {
    return new StatoObject.Builder().put("nonAXWithAXChild", true).build();
  }
