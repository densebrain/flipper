...
public class LithoRecyclerViewDescriptor extends NodeDescriptor<LithoRecylerView> {
  ...
  public void invalidate(final LithoRecylerView node) {
    ...
    new com.facebook.stato.core.ErrorReportingRunnable(mConnection) {
      @Override
  ...
  @Override
  public List<Named<StatoObject>> getData(LithoRecylerView node) throws Exception {
  ...
  @Override
  public void setValue(LithoRecylerView node, String[] path, StatoDynamic value)
      throws Exception {
    final NodeDescriptor descriptor = descriptorForClass(ViewGroup.class);
  ...
  @Override
  public StatoObject getExtraInfo(LithoRecylerView node) {
    final NodeDescriptor descriptor = descriptorForClass(ViewGroup.class);
