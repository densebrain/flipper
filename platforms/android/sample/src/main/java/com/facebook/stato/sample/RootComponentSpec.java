...
import com.facebook.stato.android.diagnostics.StatoDiagnosticActivity;
...
public class RootComponentSpec {
  ...
  static Component onCreateLayout(final ComponentContext c, @State boolean displayImage) {
    final DraweeController controller =
        Fresco.newDraweeControllerBuilder().setUri("https://fbstato.com/img/icon.png").build();
  ...
  static void openDiagnostics(final ComponentContext c) {
    Intent intent = new Intent(c.getAndroidContext(), StatoDiagnosticActivity.class);
