...
#import <StatoKitLayoutPlugin/SKDescriptorMapper.h>
#import <StatoKitLayoutPlugin/SKNodeDescriptor.h>
#import <StatoKitLayoutPlugin/StatoKitLayoutPlugin.h>
#import <StatoKitTestUtils/StatoConnectionMock.h>
...
- (void)testGetRoot {
  StatoKitLayoutPlugin *plugin = [[StatoKitLayoutPlugin alloc]
                                  initWithRootNode: [[TestNode alloc] initWithName: @"rootNode"]
                                  withTapListener: nil
                                  withDescriptorMapper: _descriptorMapper];

  StatoConnectionMock *connection = [StatoConnectionMock new];
  StatoResponderMock *responder = [StatoResponderMock new];
...
- (void)testGetEmptyNodes {
  StatoKitLayoutPlugin *plugin = [StatoKitLayoutPlugin new];
  StatoConnectionMock *connection = [StatoConnectionMock new];
  StatoResponderMock *responder = [StatoResponderMock new];
  [plugin didConnect:connection];
...
- (void)testGetNodes {
  ...
  StatoKitLayoutPlugin *plugin = [[StatoKitLayoutPlugin alloc] initWithRootNode: rootNode
                                                                withTapListener: nil
                                                           withDescriptorMapper: _descriptorMapper];
