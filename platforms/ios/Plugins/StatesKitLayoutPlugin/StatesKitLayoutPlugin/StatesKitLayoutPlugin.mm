...
#import "StatesKitLayoutPlugin.h"
...
@implementation StatesKitLayoutPlugin
{
  ...
  id<StatesConnection> _connection;
...
- (void)didConnect:(id<StatesConnection>)connection {
  ...
  // In order to avoid a retain cycle (Connection -> Block -> StatesKitLayoutPlugin -> Connection ...)
  __weak StatesKitLayoutPlugin *weakSelf = self;

  [connection receive:@"getRoot" withBlock:^(NSDictionary *params, id<StatesResponder> responder) {
    StatesPerformBlockOnMainThread(^{ [weakSelf onCallGetRoot: responder]; }, responder);
  }];
  
  [connection receive:@"getAllNodes" withBlock:^(NSDictionary *params, id<StatesResponder> responder) {
    StatesPerformBlockOnMainThread(^{ [weakSelf onCallGetAllNodesWithResponder: responder]; }, responder);
  }];

  [connection receive:@"getNodes" withBlock:^(NSDictionary *params, id<StatesResponder> responder) {
    StatesPerformBlockOnMainThread(^{ [weakSelf onCallGetNodes: params[@"ids"] withResponder: responder]; }, responder);
  }];

  [connection receive:@"setData" withBlock:^(NSDictionary *params, id<StatesResponder> responder) {
  ...
  [connection receive:@"setHighlighted" withBlock:^(NSDictionary *params, id<StatesResponder> responder) {
    StatesPerformBlockOnMainThread(^{ [weakSelf onCallSetHighlighted: params[@"id"] withResponder: responder]; }, responder);
  }];

  [connection receive:@"setSearchActive" withBlock:^(NSDictionary *params, id<StatesResponder> responder) {
    StatesPerformBlockOnMainThread(^{ [weakSelf onCallSetSearchActive: [params[@"active"] boolValue] withConnection: connection]; }, responder);
  }];

  [connection receive:@"isSearchActive" withBlock:^(NSDictionary *params, id<StatesResponder> responder) {
    StatesPerformBlockOnMainThread(^{ [weakSelf onCallIsSearchActiveWithConnection: responder]; }, responder);
  }];

  [connection receive:@"isConsoleEnabled" withBlock:^(NSDictionary *params, id<StatesResponder> responder) {
    StatesPerformBlockOnMainThread(^{ [responder success: @{@"isEnabled": @NO}];}, responder);
  }];

  [connection receive:@"getSearchResults" withBlock:^(NSDictionary *params, id<StatesResponder> responder) {
    StatesPerformBlockOnMainThread(^{ [weakSelf onCallGetSearchResults: params[@"query"] withResponder: responder]; }, responder);
  }];
}
...
- (void)onCallGetRoot:(id<StatesResponder>)responder {
...
- (void)onCallGetAllNodesWithResponder:(nonnull id<StatesResponder>)responder {
...
- (void)onCallGetNodes:(NSArray<NSDictionary *> *)nodeIds withResponder:(id<StatesResponder>)responder {
...
- (void)onCallSetData:(NSString *)objectId
       ...
       withConnection:(id<StatesConnection>)connection {
...
- (void)onCallGetSearchResults:(NSString *)query withResponder:(id<StatesResponder>)responder {
...
- (void)onCallSetHighlighted:(NSString *)objectId withResponder:(id<StatesResponder>)responder {
...
- (void)onCallSetSearchActive:(BOOL)active withConnection:(id<StatesConnection>)connection {
  if (active) {
...
- (void)onCallIsSearchActiveWithConnection:(id<StatesResponder>)responder {
