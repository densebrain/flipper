...
#import <StatesKitLayoutPlugin/SKNodeDescriptor.h>
#import <StatesKitLayoutPlugin/StatesKitLayoutPlugin.h>
#import <StatesKitTestUtils/StatesConnectionMock.h>
...
- (void)testGetRoot {
  StatesKitLayoutPlugin *plugin = [[StatesKitLayoutPlugin alloc]
                                  initWithRootNode: [[TestNode alloc] initWithName: @"rootNode"]
                                  withTapListener: nil
                                  withDescriptorMapper: _descriptorMapper];

  StatesConnectionMock *connection = [StatesConnectionMock new];
  StatesResponderMock *responder = [StatesResponderMock new];
...
- (void)testGetEmptyNodes {
  StatesKitLayoutPlugin *plugin = [StatesKitLayoutPlugin new];
  StatesConnectionMock *connection = [StatesConnectionMock new];
  StatesResponderMock *responder = [StatesResponderMock new];
  [plugin didConnect:connection];
...
- (void)testGetNodes {
  ...
  StatesKitLayoutPlugin *plugin = [[StatesKitLayoutPlugin alloc] initWithRootNode: rootNode
                                                                withTapListener: nil
                                                           withDescriptorMapper: _descriptorMapper];
