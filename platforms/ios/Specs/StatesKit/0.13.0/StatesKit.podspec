...
Pod::Spec.new do |spec|
  ...
  spec.subspec "StatesKitCrashReporterPlugin" do |ss|
    ss.header_dir = "StatesKitCrashReporterPlugin"
    ss.dependency 'StatesKit/Core'
    ss.compiler_flags       = folly_compiler_flags
    ss.public_header_files = 'iOS/Plugins/StatesKitCrashReporterPlugin/StatesKitCrashReporterPlugin/StatesKitCrashReporterPlugin.h'
    ss.source_files         = "iOS/Plugins/StatesKitCrashReporterPlugin/**/*.{h,mm}"
    ss.pod_target_xcconfig = { "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)\"/Headers/Private/StatesKit/**" }
  end
end
