...
Pod::Spec.new do |spec|
  ...
  # generally (you would need to import <StatesKit/t/FBDefines/FBMacros.h>)
  ...
  spec.subspec "Core" do |ss|
    ...
    ss.compiler_flags = folly_compiler_flags
    ss.source_files = 'iOS/StatesKit/FBDefines/*.{h,cpp,m,mm}', 'iOS/StatesKit/CppBridge/*.{h,mm}', 'iOS/StatesKit/FBCxxUtils/*.{h,mm}', 'iOS/StatesKit/Utilities/**/*.{h,m}', 'iOS/StatesKit/*.{h,m,mm}'
    ss.public_header_files = 'iOS/Plugins/StatesKitNetworkPlugin/SKIOSNetworkPlugin/SKIOSNetworkAdapter.h',
                             ...
                             'iOS/StatesKit/**/{StatesStateUpdateListener,StatesClient,StatesPlugin,StatesConnection,StatesResponder,SKMacros}.h'
  ...
  spec.subspec "StatesKitLayoutPlugin" do |ss|
    ...
    ss.public_header_files = 'iOS/Plugins/StatesKitLayoutPlugin/StatesKitLayoutPlugin/StatesKitLayoutPlugin.h',
                              'iOS/Plugins/StatesKitLayoutPlugin/StatesKitLayoutPlugin/SKTouch.h',
  ...
  spec.subspec "StatesKitLayoutComponentKitSupport" do |ss|
    ...
    ss.public_header_files = 'iOS/Plugins/StatesKitLayoutPlugin/StatesKitLayoutComponentKitSupport/StatesKitLayoutComponentKitSupport.h',
                             'iOS/Plugins/StatesKitLayoutPlugin/StatesKitLayoutComponentKitSupport/SKComponentLayoutWrapper.h'

    ss.source_files         = "iOS/Plugins/StatesKitLayoutPlugin/StatesKitLayoutComponentKitSupport/**/*.{h,cpp,m,mm}"
    ss.pod_target_xcconfig = { "USE_HEADERMAP" => "NO",
                                "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)\"/Headers/Private/StatesKit/**" }
  end
