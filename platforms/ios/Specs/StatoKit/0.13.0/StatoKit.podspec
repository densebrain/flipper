folly_compiler_flags = '-DSTATO_OSS=1 -DFB_SONARKIT_ENABLED=1 -DFOLLY_NO_CONFIG -DFOLLY_MOBILE=1 -DFOLLY_USE_LIBCPP=1 -DFOLLY_HAVE_LIBGFLAGS=0 -DFOLLY_HAVE_LIBJEMALLOC=0 -DFOLLY_HAVE_PREADV=0 -DFOLLY_HAVE_PWRITEV=0 -DFOLLY_HAVE_TFO=0 -DFOLLY_USE_SYMBOLIZER=0'
yoga_version = '~> 1.9'
yogakit_version = '~>1.8'
statokit_version = '0.13.0'
Pod::Spec.new do |spec|
  ...
  # generally (you would need to import <StatoKit/t/FBDefines/FBMacros.h>)
  ...
  spec.subspec "StatoKitCrashReporterPlugin" do |ss|
    ss.header_dir = "StatoKitCrashReporterPlugin"
    ss.dependency 'StatoKit/Core'
    ss.compiler_flags       = folly_compiler_flags
    ss.public_header_files = 'iOS/Plugins/StatoKitCrashReporterPlugin/StatoKitCrashReporterPlugin/StatoKitCrashReporterPlugin.h'
    ss.source_files         = "iOS/Plugins/StatoKitCrashReporterPlugin/**/*.{h,mm}"
    ss.pod_target_xcconfig = { "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)\"/Headers/Private/StatoKit/**" }
  end
end
