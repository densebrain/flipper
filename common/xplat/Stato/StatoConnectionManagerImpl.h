...
class StatoConnectionManagerImpl : public StatoConnectionManager {
  friend ConnectionEvents;

 public:
  StatoConnectionManagerImpl(StatoInitConfig config, std::shared_ptr<StatoState> state, std::shared_ptr<ConnectionContextStore> contextStore);

  ~StatoConnectionManagerImpl();
