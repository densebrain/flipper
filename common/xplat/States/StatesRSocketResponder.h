...
class StatesConnectionManager;

class StatesRSocketResponder : public rsocket::RSocketResponder {
 private:
  StatesConnectionManager* websocket_;
  folly::EventBase* eventBase_;

 public:
  StatesRSocketResponder(
      StatesConnectionManager* websocket,
