...
if(NOT ANDROID_NDK AND NOT $ENV{ANDROID_NDK} STREQUAL "")
...
if(NOT ANDROID_NDK)
  ...
  if(NOT "${ANDROID_NDK}" STREQUAL "${ANDROID_NDK_EXPECTED_PATH}")
    message(STATUS "Using custom NDK path (ANDROID_NDK is set): ${ANDROID_NDK}")
  endif()
endif()
...
if (NOT CMAKE_HOST_SYSTEM_NAME)
  message(STATUS "Checking for host system name")
  execute_process(COMMAND uname OUTPUT_VARIABLE CMAKE_HOST_SYSTEM_NAME)
endif()
...
message(STATUS "System name ${CMAKE_HOST_SYSTEM_NAME} tag ${ANDROID_HOST_TAG}")
