 ...
 * @format
 */
import { ManagedTable, Text, Heading, FlexColumn, colors, FlexRow, ManagedDataInspector, styled, Select } from "flipper"
...
export default class extends FlipperPlugin<SharedPreferencesState> {
  ...
  reducers = {
    ...
    UpdateSelectedSharedPreferences(state: SharedPreferencesState, event: Object) {
      return {
