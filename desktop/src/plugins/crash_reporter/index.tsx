...
import { Store, DeviceLogEntry, OS, PluginProps } from "flipper"
...
export function parseCrashLogAndUpdateState(
  ...
  const persistingPlugin:
    ...
    | null
    | undefined = store.getState().plugins.devicePlugins.get(CrashReporterPlugin.id)
...
export default class CrashReporterPlugin extends FlipperDevicePlugin<State, undefined, PersistedState> {
  ...
  static persistedStateReducer = (persistedState: PersistedState, method: string, payload: Object): PersistedState => {
