 ...
 * @format
 */
import { ElementID, Element, ElementSearchResultSet, MiddlewareAPI, PluginClient } from "flipper"
...
export default class Layout extends FlipperPlugin<State, undefined, PersistedState> {
  static exportPersistedState = (
    callClient: (a: string, b: Object | null | undefined) => Promise<Object>,
    persistedState: PersistedState | null | undefined,
    store: MiddlewareAPI | null | undefined
  ): Promise<PersistedState | null | undefined> => {
