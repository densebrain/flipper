 ...
 * @format
 */
import { ElementID, Element, PluginClient, ElementSearchResultSet } from "flipper"
...
export default class Inspector extends Component<Props> {
  ...
  componentDidUpdate(prevProps: Props) {
    ...
    if (ax && selectedElement !== prevProps.selectedElement && selectedElement) {
      ...
      const linkedAXNode: ElementID | null | undefined = this.props.persistedState.elements[selectedElement]?.extraInfo
        ?.linkedAXNode
