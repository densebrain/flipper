...
const rootContextMenuCache: WeakMap<Object, Array<Electron$MenuItemOptions>> = new WeakMap()
  ...
  render(): any {
    ...
    if (isExpanded || !isExpandable) {
      ...
      descriptionOrPreview = (
        <DataPreview type={type} value={value} setValue={setValue} extractValue={this.extractValue} depth={depth} />
      )
    }
