...
const Padder = styled('div')(styleCreator(({padded, backgroundColor}) => ({
  padding: padded ? 10 : 0,
  backgroundColor,
}),['padded','backgroundColor']));

const Container = styled('div')(styleCreator(({isCrash, padded}) => ({
...
const Title = styled(FlexRow)(styleCreator(({isCrash}) => ({
...
const Reason = styled(Text)(styleCreator(({isCrash}) => ({
  color: isCrash ? colors.red : colors.light80,
  fontWeight: 'bold',
  fontSize: 13,
}),['isCrash','padded','backgroundColor']));

const Line = styled(Text)(styleCreator(({isCrash, isBold}) => ({
  color: isCrash ? colors.red : colors.light80,
