...
import { WithStylesOptions } from '../themes/withStylesAndTheme';
import { withStyles } from '../themes/withStylesAndTheme';
import { StyledElement, StylerFnOrStyles } from './StyleTypes';
import filterProps from 'react-valid-props';
import { memoFn } from '../../utils/memoize'; //import {React$Element} from 'react';
...
function styled<Props extends any>(Component: StyledElement<Props>, componentName: string | null | undefined = null) {
  return (style: StylerFnOrStyles<Props>, options: WithStylesOptions | null | undefined = null) => {
    const StyledComponent: any = React.forwardRef((props, ref) => {
      ...
      return React.createElement(FinalComponent, { ...AllProps,
        className,
        ...(ref ? {
          ref
        } : {})
    ...
    hoistNonReactStatics(StyledComponent, Component); //return React.memo((withStyles((styles: any), options || {}): any)(StyledComponent));
