...
type TablePluginProps<T, ExtraProps> = {
  method:string;
  resetMethod?:string;
...
export type CreateTablePluginProps<RowData extends TablePluginRowData,
  ...
  ExtraProps = any> =
  TablePluginProps<RowData, ExtraProps>
  & TablePluginMetadata
  & Omit<Plugin<State, PersistedState, ExtraProps>, "componentClazz" | "component">
...
export function createTablePlugin<
  ...
  ExtraProps = any
>(props:CreateTablePluginProps<RowData, State, PersistedState, ExtraProps>):Plugin<State, PersistedState, TablePluginProps<RowData, ExtraProps>> {
  ...
  const PluginComponent = class PluginComponent extends FlipperPlugin<State, any, PersistedState, TablePluginProps<RowData, ExtraProps>> {
    ...
    static persistedStateReducer(persistedState:PersistedState, method:string, payload:RowData | Array<RowData>):Partial<PersistedState> {
