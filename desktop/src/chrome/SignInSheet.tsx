 ...
 * @format
 */
import { FlexColumn, Button, styled, Text, Component, FlexRow, Spacer, Input, Link, colors } from 'flipper';
...
class SignInSheet extends Component<Props, State> {
  ...
  render() {
    return <Container>
        ...
        <TokenInput disabled={this.state.loading} placeholder="Nuclide Access Token" value={this.state.token} onChange={e => this.setState({
        token: e.target.value
      })} />
        {this.state.error && <InfoText color={colors.red}>
