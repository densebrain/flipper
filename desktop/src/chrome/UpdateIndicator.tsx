...
export default class UpdateIndicator extends Component<Props, undefined> {
  render() {
    ...
    return (
      <Container>
        <span title={this.props.launcherMsg.message}>
          <Glyph color={getSeverityColor(this.props.launcherMsg.severity)} name="caution-triangle" />
        </span>
      </Container>
    )
  }
