...
import { FlexColumn, Button, styled, colors, Text, LoadingIndicator, FlexRow, Spacer, Input } from "flipper"
...
export default class ShareSheet extends React.Component<Props, State> {
  static contextTypes = {
