...
export default class ImagePool {
  ...
  constructor(fetchImage: (imageId: ImageId) => void, onPoolUpdated: (images: ImagesMap) => void) {
  ...
  _fetchCompleted(image: ImageData) {
