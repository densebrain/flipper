import {ConnectionStatus, DuplexConnection, Frame, ISubject, ISubscription, SetupFrame} from "rsocket-types"
...
export default class RSocketResumableTransport implements DuplexConnection {
  ...
  sendOne(frame: Frame): undefined

  send(frames: Flowable<Frame>): undefined
