...
declare global {
  namespace sugarjsLocal {
    ...
    interface SugarLocal {
      (opts?:ExtendOptions):SugarLocal;
      
      createNamespace(name:string):SugarNamespace;
      
      extend(opts?:ExtendOptions):SugarLocal;
    ...
    namespace Array {
      ...
      interface Constructor extends SugarNamespace {
        ...
        //
        // average<T, U>(instance:T[], map?:mapFn<T, U>):number;
        //
        // clone<T>(instance:T[]):T[];
        //
        // compact<T>(instance:T[], all?:boolean):T[];
        //
        // count<T>(instance:T[], search:searchFn<T>, context?:any):number;
        //
        // every<T>(instance:T[], search:searchFn<T>, context?:any):boolean;
        //
        ...
        //
        // exclude<T>(instance:T[], search:searchFn<T>):T[];
        
        //filter<T>(instance:T[], search:searchFn<T>, context?:any):T[];
        ...
        //
        // find<T>(instance:T[], search:searchFn<T>, context?:any):T;
        //
        ...
        //
        // findIndex<T>(instance:T[], search:searchFn<T>, context?:any):number;
        //
        ...
        //
        // groupBy<T, U>(instance:T[], map:mapFn<T, U>, groupFn?:(arr:T[], key:string, obj:Object) => void):Object;
        //
        ...
        //
        // least<T, U>(instance:T[], all?:boolean, map?:mapFn<T, U>):T[];
        //
        // least<T, U>(instance:T[], map?:mapFn<T, U>):T[];
        //
        // map<T, U>(instance:T[], map:mapFn<T, U>, context?:any):U[];
        //
        ...
        //
        // max<T, U>(instance:T[], all?:boolean, map?:mapFn<T, U>):T;
        //
        // max<T, U>(instance:T[], map?:mapFn<T, U>):T;
        //
        // median<T, U>(instance:T[], map?:mapFn<T, U>):number;
        //
        // min<T, U>(instance:T[], all?:boolean, map?:mapFn<T, U>):T;
        //
        // min<T, U>(instance:T[], map?:mapFn<T, U>):T;
        //
        // most<T, U>(instance:T[], all?:boolean, map?:mapFn<T, U>):T[];
        //
        // most<T, U>(instance:T[], map?:mapFn<T, U>):T[];
        //
        // none<T>(instance:T[], search:searchFn<T>, context?:any):boolean;
        //
        ...
        //
        // remove<T>(instance:T[], search:searchFn<T>):T[];
        //
        ...
        //
        // some<T>(instance:T[], search:searchFn<T>, context?:any):boolean;
        //
        ...
        //
        // sortBy<T, U>(instance:T[], map?:sortMapFn<T, U>, desc?:boolean):T[];
        //
        // subtract<T>(instance:T[], item:T | T[]):T[];
        //
        // sum<T, U>(instance:T[], map?:mapFn<T, U>):number;
        //
        // to<T>(instance:T[], index:number):T[];
        //
        // union<T>(instance:T[], arr:T[]):T[];
        //
        // unique<T, U>(instance:T[], map?:mapFn<T, U>):T[];
        //
      ...
      interface ChainableBase<T, RawValue> {
        ...
        average<U>(map?:mapFn<T, U>):SugarDefaultChainable<number>;
        
        clone():SugarDefaultChainable<T[]>;
        
        compact(all?:boolean):SugarDefaultChainable<T[]>;
        
        count(search:searchFn<T>, context?:any):SugarDefaultChainable<number>;
        
        every(search:searchFn<T>, context?:any):SugarDefaultChainable<boolean>;
        ...
        exclude(search:searchFn<T>):SugarDefaultChainable<T[]>;
        
        //filter(search:searchFn<T>, context?:any):SugarDefaultChainable<T[]>;
        ...
        //find(search:searchFn<T>, context?:any):SugarDefaultChainable<T>;
        ...
        findIndex(search:searchFn<T>, context?:any):SugarDefaultChainable<number>;
        ...
        groupBy<U>(map:mapFn<T, U>, groupFn?:(arr:T[], key:string, obj:Object) => SugarDefaultChainable<void>):SugarDefaultChainable<Object>;
        ...
        least<U>(all?:boolean, map?:mapFn<T, U>):SugarDefaultChainable<T[]>;
        
        least<U>(map?:mapFn<T, U>):SugarDefaultChainable<T[]>;
        
        //map<U>(map:mapFn<T, U>, context?:any):SugarDefaultChainable<U[]>;
        ...
        max<U>(all?:boolean, map?:mapFn<T, U>):SugarDefaultChainable<T>;
        
        max<U>(map?:mapFn<T, U>):SugarDefaultChainable<T>;
        
        median<U>(map?:mapFn<T, U>):SugarDefaultChainable<number>;
        
        min<U>(all?:boolean, map?:mapFn<T, U>):SugarDefaultChainable<T>;
        
        min<U>(map?:mapFn<T, U>):SugarDefaultChainable<T>;
        
        most<U>(all?:boolean, map?:mapFn<T, U>):SugarDefaultChainable<T[]>;
        
        most<U>(map?:mapFn<T, U>):SugarDefaultChainable<T[]>;
        
        //none(search:searchFn<T>, context?:any):SugarDefaultChainable<boolean>;
        ...
        remove(search:searchFn<T>):SugarDefaultChainable<T[]>;
        ...
        //some(search:searchFn<T>, context?:any):SugarDefaultChainable<boolean>;
        ...
        sortBy<U>(map?:sortMapFn<T, U>, desc?:boolean):SugarDefaultChainable<T[]>;
        
        subtract(item:T | T[]):SugarDefaultChainable<T[]>;
        
        sum<U>(map?:mapFn<T, U>):SugarDefaultChainable<number>;
        
        to(index:number):SugarDefaultChainable<T[]>;
        
        union(arr:T[]):SugarDefaultChainable<T[]>;
        
        unique<U>(map?:mapFn<T, U>):SugarDefaultChainable<T[]>;
    ...
    //namespace Object {
      ...
      //
      //   average<T, U>(instance:Object, map?:mapFn<T, U>):number;
      //
      //   clone(instance:Object, deep?:boolean):Object;
      //
      //   count<T>(instance:Object, search:searchFn<T>):number;
      //
      //   defaults<T>(instance:Object, sources:Array<Object>, options?:ObjectMergeOptions<T>):Object;
      //
      //   every<T>(instance:Object, search:searchFn<T>):boolean;
      //
      //   exclude<T>(instance:Object, search:searchFn<T>):Object;
      //
      //   filter<T>(instance:Object, search:searchFn<T>):T[];
      //
      //   find<T>(instance:Object, search:searchFn<T>):boolean;
      //
      ...
      //
      //   least<T, U>(instance:Object, all?:boolean, map?:mapFn<T, U>):T;
      //
      //   least<T, U>(instance:Object, map?:mapFn<T, U>):T;
      //
      //   map<T, U>(instance:Object, map:mapFn<T, U>):Object;
      //
      //   max<T, U>(instance:Object, all?:boolean, map?:mapFn<T, U>):T;
      //
      //   max<T, U>(instance:Object, map?:mapFn<T, U>):T;
      //
      //   median<T, U>(instance:Object, map?:mapFn<T, U>):number;
      //
      ...
      //
      //   min<T, U>(instance:Object, all?:boolean, map?:mapFn<T, U>):T;
      //
      //   min<T, U>(instance:Object, map?:mapFn<T, U>):T;
      //
      //   most<T, U>(instance:Object, all?:boolean, map?:mapFn<T, U>):T;
      //
      //   most<T, U>(instance:Object, map?:mapFn<T, U>):T;
      //
      //   none<T>(instance:Object, search:searchFn<T>):boolean;
      //
      ...
      //
      //   remove<T>(instance:Object, search:searchFn<T>):Object;
      //
      ...
      //
      //   some<T>(instance:Object, search:searchFn<T>):boolean;
      //
      //   subtract(instance:Object, obj:Object):Object;
      //
      //   sum<T, U>(instance:Object, map?:mapFn<T, U>):number;
      //
      ...
      //   toString:() => string;
        ...
        //
        // average<T, U>(map?:mapFn<T, U>):SugarDefaultChainable<number>;
        //
        // clone(deep?:boolean):SugarDefaultChainable<Object>;
        //
        // count<T>(search:searchFn<T>):SugarDefaultChainable<number>;
        //
        // defaults<T>(sources:Array<Object>, options?:ObjectMergeOptions<T>):SugarDefaultChainable<Object>;
        //
        // every<T>(search:searchFn<T>):SugarDefaultChainable<boolean>;
        //
        // exclude<T>(search:searchFn<T>):SugarDefaultChainable<Object>;
        //
        // filter<T>(search:searchFn<T>):SugarDefaultChainable<T[]>;
        //
        // find<T>(search:searchFn<T>):SugarDefaultChainable<boolean>;
        //
        ...
        //
        // least<T, U>(all?:boolean, map?:mapFn<T, U>):SugarDefaultChainable<T>;
        //
        // least<T, U>(map?:mapFn<T, U>):SugarDefaultChainable<T>;
        //
        // map<T, U>(map:mapFn<T, U>):SugarDefaultChainable<Object>;
        //
        // max<T, U>(all?:boolean, map?:mapFn<T, U>):SugarDefaultChainable<T>;
        //
        // max<T, U>(map?:mapFn<T, U>):SugarDefaultChainable<T>;
        //
        // median<T, U>(map?:mapFn<T, U>):SugarDefaultChainable<number>;
        //
        ...
        //
        // min<T, U>(all?:boolean, map?:mapFn<T, U>):SugarDefaultChainable<T>;
        //
        // min<T, U>(map?:mapFn<T, U>):SugarDefaultChainable<T>;
        //
        // most<T, U>(all?:boolean, map?:mapFn<T, U>):SugarDefaultChainable<T>;
        //
        // most<T, U>(map?:mapFn<T, U>):SugarDefaultChainable<T>;
        //
        // none<T>(search:searchFn<T>):SugarDefaultChainable<boolean>;
        //
        ...
        //
        // remove<T>(search:searchFn<T>):SugarDefaultChainable<Object>;
        //
        ...
        //
        // some<T>(search:searchFn<T>):SugarDefaultChainable<boolean>;
        //
        // subtract(obj:Object):SugarDefaultChainable<Object>;
        //
        // sum<T, U>(map?:mapFn<T, U>):SugarDefaultChainable<number>;
        //
...
//   const SugarLocal: sugarjsLocal.SugarLocal;
//   export = SugarLocal;
// }

//declare const Sugar: sugarjsLocal.SugarLocal;
export {}
