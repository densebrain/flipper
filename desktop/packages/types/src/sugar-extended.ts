...
declare global {
  ...
  interface Array<T> {
    ...
    average<U>(map?:sugarjsLocal.Array.mapFn<T, U>):number;
    
    clone():T[];
    
    compact(all?:boolean):T[];
    
    count(search:sugarjsLocal.Array.searchFn<T>, context?:any):number;
    
    //every(search:sugarjsLocal.Array.searchFn<T>, context?:any):boolean;
    
    //everyFromIndex(startIndex:number, loop?:boolean, ...args:any[]):T;
    
    //everyFromIndex(startIndex:number, ...args:any[]):T;
    
    exclude(search:sugarjsLocal.Array.searchFn<T>):T[];
    
    //filter(search:sugarjsLocal.Array.searchFn<T>, context?:any):T[];
    
    filterFromIndex(startIndex:number, loop?:boolean, ...args:any[]):T;
    
    filterFromIndex(startIndex:number, ...args:any[]):T;
    
    //find(search:sugarjsLocal.Array.searchFn<T>, context?:any):T;
    
    findFromIndex(startIndex:number, loop?:boolean, ...args:any[]):T;
    
    findFromIndex(startIndex:number, ...args:any[]):T;
    
    findIndex(search:sugarjsLocal.Array.searchFn<T>, context?:any):number;
    ...
    groupBy<U>(map:sugarjsLocal.Array.mapFn<T, U>, groupFn?:(arr:T[], key:string, obj:Object) => void):Object;
    ...
    least<U>(all?:boolean, map?:sugarjsLocal.Array.mapFn<T, U>):T[];
    
    least<U>(map?:sugarjsLocal.Array.mapFn<T, U>):T[];
    
    //map<U>(map:sugarjsLocal.Array.mapFn<T, U>, context?:any):U[];
    
    mapFromIndex(startIndex:number, loop?:boolean, ...args:any[]):T;
    
    mapFromIndex(startIndex:number, ...args:any[]):T;
    
    max<U>(all?:boolean, map?:sugarjsLocal.Array.mapFn<T, U>):T;
    
    max<U>(map?:sugarjsLocal.Array.mapFn<T, U>):T;
    
    median<U>(map?:sugarjsLocal.Array.mapFn<T, U>):number;
    
    min<U>(all?:boolean, map?:sugarjsLocal.Array.mapFn<T, U>):T;
    
    min<U>(map?:sugarjsLocal.Array.mapFn<T, U>):T;
    
    most<U>(all?:boolean, map?:sugarjsLocal.Array.mapFn<T, U>):T[];
    
    most<U>(map?:sugarjsLocal.Array.mapFn<T, U>):T[];
    
    none(search:sugarjsLocal.Array.searchFn<T>, context?:any):boolean;
    ...
    remove(search:sugarjsLocal.Array.searchFn<T>):T[];
    ...
    some(search:sugarjsLocal.Array.searchFn<T>, context?:any):boolean;
    
    someFromIndex(startIndex:number, loop?:boolean, ...args:any[]):T;
    
    someFromIndex(startIndex:number, ...args:any[]):T;
    
    sortBy<U>(map?:sugarjsLocal.Array.sortMapFn<T, U>, desc?:boolean):T[];
    
    subtract(item:T | T[]):T[];
    
    sum<U>(map?:sugarjsLocal.Array.mapFn<T, U>):number;
    
    to(index:number):T[];
    
    union(arr:T[]):T[];
    
    unique<U>(map?:sugarjsLocal.Array.mapFn<T, U>):T[];
  ...
  interface ObjectConstructor {
    ...
    //
    // average<T, U>(instance:T, map?:sugarjsLocal.Object.mapFn<T, U>):number;
    //
    // clone<T>(instance:T, deep?:boolean):T;
    //
    // count<T>(instance:T, search:sugarjsLocal.Object.searchFn<T>):number;
    //
    // defaults<T>(instance:T, sources:Array<Object>, options?:sugarjsLocal.Object.ObjectMergeOptions<T>):Object;
    //
    //every<T>(instance:T, search:sugarjsLocal.Object.searchFn<T>):boolean;
    
    //exclude<T>(instance:T, search:sugarjsLocal.Object.searchFn<T>):Object;
    
    //filter<T>(instance:T, search:sugarjsLocal.Object.searchFn<T>):T[];
    
    //find<T>(instance:T, search:sugarjsLocal.Object.searchFn<T>):boolean;
    ...
    //least<T, U>(instance:T, all?:boolean, map?:sugarjsLocal.Object.mapFn<T, U>):T;
    
    //least<T, U>(instance:T, map?:sugarjsLocal.Object.mapFn<T, U>):T;
    
    //map<T, U>(instance:T, map:sugarjsLocal.Object.mapFn<T, U>):Object;
    
    // max<T, U>(instance:T, all?:boolean, map?:sugarjsLocal.Object.mapFn<T, U>):T;
    //
    // max<T, U>(instance:T, map?:sugarjsLocal.Object.mapFn<T, U>):T;
    //
    // median<T, U>(instance:T, map?:sugarjsLocal.Object.mapFn<T, U>):number;
    //
    ...
    //
    // min<T, U>(instance:T, all?:boolean, map?:sugarjsLocal.Object.mapFn<T, U>):T;
    //
    // min<T, U>(instance:T, map?:sugarjsLocal.Object.mapFn<T, U>):T;
    //
    // most<T, U>(instance:T, all?:boolean, map?:sugarjsLocal.Object.mapFn<T, U>):T;
    //
    // most<T, U>(instance:T, map?:sugarjsLocal.Object.mapFn<T, U>):T;
    //
    // none<T>(instance:T, search:sugarjsLocal.Object.searchFn<T>):boolean;
    //
    ...
    //
    // remove<T>(instance:T, search:sugarjsLocal.Object.searchFn<T>):Partial<T>;
    //
    ...
    //
    // some<T>(instance:T, search:sugarjsLocal.Object.searchFn<T>):boolean;
    //
    // subtract<T>(instance:T, obj:Partial<T>):Partial<T>;
    //
    // sum<T, U>(instance:T, map?:sugarjsLocal.Object.mapFn<T, U>):number;
    //
