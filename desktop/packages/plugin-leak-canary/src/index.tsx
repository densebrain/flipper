    ...
    return (
      <Sidebar position="right" width={600} minWidth={300} maxWidth={900}>
        <Panel heading={"Instance"} floating={false} grow={false}>
          <ManagedDataInspector data={instanceFields} expandRoot={true} extractValue={this._extractValue} />
        </Panel>
        <Panel heading={"Static"} floating={false} grow={false}>
          <ManagedDataInspector data={staticFields} expandRoot={true} extractValue={this._extractValue} />
        </Panel>
      </Sidebar>
    )
  }
