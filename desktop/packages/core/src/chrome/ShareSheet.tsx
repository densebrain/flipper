...
const Padder = styled("div")(
  ({ paddingLeft, paddingRight, paddingBottom, paddingTop }: any) => ({
...
export default withTheme()(
  class ShareSheet extends React.Component<Props, State> {
    static contextTypes = {
              ...
              <FlexColumn>
                {getValue(() => this.state.result!!.statoUrl) ? (
                  <>
                    ...
                    <InfoText>
                      Stato&quot;s data was successfully uploaded. This URL can
                      be used to share with other Stato users. Opening it will
                      import the data from your trace.
                    </InfoText>
                    <Copy value={this.state.result.statoUrl} />
                    <InfoText>
                      When sharing your Stato link, consider that the captured
                    ...
                    {this.state.errorArray.length > 0 && (
                      <Padder paddingBottom={8}>
                        <FlexColumn>
                          ...
                          {this.state.errorArray.map((e: Error, index) => (
                            <ErrorMessage key={index} code>
                              {e.toString()}
                            </ErrorMessage>
                          ))}
                        </FlexColumn>
                  ...
                  <>
                    <Title bold>
                      {this.state.result.error_class || "Error"}
                    </Title>
                    <ErrorMessage code>
