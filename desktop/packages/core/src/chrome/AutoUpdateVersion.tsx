...
type State = {
  updater: "error" | "checking-for-update" | "update-available" | "update-not-available" | "update-downloaded",
  error?: string
}
type Props = ThemeProps<{
  version: string
},string,true>
export default withTheme()(class AutoUpdateVersion extends React.Component<Props, State> {
