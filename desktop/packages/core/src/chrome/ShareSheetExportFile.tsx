...
export default withTheme()(
  class ShareSheetExportFile extends React.Component<Props, State> {
    static contextTypes = {
          ...
          return (
            <Container>
              <FlexColumn>
                ...
                <InfoText>
                  When sharing your Stato data, consider that the captured data
        ...
        if (error) {
          return (
            <Container>
              ...
              <ErrorMessage code>
                {getValue(() => error!!.message) || "File could not be saved."}
              </ErrorMessage>
              <FlexRow>
                <Spacer />
                <Button compact padded onClick={this.props.onHide}>
