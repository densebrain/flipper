 ...
 * @format
 */
import { shouldParseAndroidLog } from "../crashReporterUtility"
import {DeviceLogEntry, LogLevel} from "../../devices/BaseDevice"


function getAndroidLog(date: Date, type: LogLevel, tag: string, message: string): DeviceLogEntry {
  return {
    date,
    type,
    tag,
