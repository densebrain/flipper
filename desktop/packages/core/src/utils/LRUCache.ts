...
class ListElement<K, V> {
  ...
  creationTime: number
  cache: LRUCache<K, V>
  before: ListElement<K, V> | null | undefined
  next: ListElement<K, V> | null | undefined
  key: K
  value: V
...
export default class LRUCache<K, V> {
  ...
  tail: ListElement<K, V> | null | undefined
  head: ListElement<K, V> | null | undefined
  ...
  get(key: K, hit: boolean = true): V | null | undefined {
  ...
  pop(): ListElement<K, V> | null | undefined {
    const { tail } = this
  ...
  set(key: K, val: V, hit: boolean = true) {
    ...
    if (actual) {
      ...
      let cacheVal: ListElement<K, V> | null | undefined
