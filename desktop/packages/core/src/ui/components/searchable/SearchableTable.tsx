...
type Props = ManagedTableProps & SearchableProps & {
...
class SearchableManagedTable extends PureComponent<Props, State> {
  ...
  setTableRef = (tableRef:ManagedTable | null) => this.setState({
    tableRef
  }, () => guard(() => this.props.innerRef(tableRef)));
  ...
  componentWillReceiveProps(nextProps: Props) {
    ...
    if (Object.keys(patch).length) {
      ...
      this.setState(state => ({...state,...patch}), () => patch.filteredItems && guard(() => this.state.tableRef.resetTable()));
    }
  }
