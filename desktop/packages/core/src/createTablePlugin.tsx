...
import {FlipperPluginComponent, FlipperPluginProps} from './plugin'
...
>(props:CreateTablePluginProps<RowData, State, Actions, PersistedState, ExtraProps>):Plugin<Props, State, Actions, PersistedState> {
  ...
  const PluginComponent = class PluginComponent extends FlipperPluginComponent<Props,State, Actions, PersistedState> {
